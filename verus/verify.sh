...
for f in extent_coalesce.rs extent_leaf.rs extent_node.rs extent_split.rs extent_chain.rs extent_link.rs rmap.rs rmap_cluster.rs extent_tree.rs extent_ptr_tree.rs; do
  echo "--- $f ---"
