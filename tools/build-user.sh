...
for bin in init hello echo_client initramfs_srv ramdisk_srv blk_srv fat16_srv console_srv shell net_srv pipe_upper spin bench pong grant_echo macro_bench; do
